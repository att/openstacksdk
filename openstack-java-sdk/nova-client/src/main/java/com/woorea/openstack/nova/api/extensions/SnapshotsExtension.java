 ...
 * <h2>Revisions</h2>
 * <dl>
 * <dd>Changed snapshot create method parameter from SnapshotForCreate to Snapshot</dd>
 * </dl>
 */
public class SnapshotsExtension {
    ...
    public class Create extends OpenStackRequest<Snapshot> {
        ...
        public Create(SnapshotForCreate snapshotForCreate) {
            super(CLIENT, HttpMethod.POST, "/os-snapshots", Entity.json(snapshotForCreate), Snapshot.class);
    ...
    public class ShowMetadata extends OpenStackRequest<Metadata> {
        ...
        public ShowMetadata(String id) {
            super(CLIENT, HttpMethod.GET,
                new StringBuilder("/os-snapshots/").append(id).append("/metadata").toString(), null, Metadata.class);
        }
